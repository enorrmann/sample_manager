...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-BgryEVme.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-B4URIlVE.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-BYY98yvM.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-Av-Btm-8.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-B18hV_w1.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-BR2u6KqP.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-BZJsWqoQ.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-Bpe_aHlZ.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-D5NqjYZE.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-cPjaTy2z.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-DTpNSBCe.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-Bu9D6hYF.js")).WaveParser;
  }
};
...
function inferTagsFromFilename(filename) {
  const tokens = filename.split(/[\s_\-\.]+/);
    ...
    for (const subToken of subTokens) {
      ...
      if (COMMON_TAGS[normalized]) {
        ...
        if (normalized.length > 3 && /^[a-z]+$/.test(normalized)) {
          tags.add(normalized.charAt(0).toUpperCase() + normalized.slice(1));
        }
      }
    }
  }
