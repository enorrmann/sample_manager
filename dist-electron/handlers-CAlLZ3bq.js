...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-BzRtuwT7.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-D12x-6Ig.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-EqkAXWB9.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-ptArbFwF.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BdeWHVJ9.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-F04K8I6t.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-yKRPEPF7.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-V8mvVWEC.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-BSlic0yr.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-D6SYV9Iy.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-BkQXo_tg.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-cnO70zEq.js")).WaveParser;
  }
};
...
function inferTagsFromFilename(filePath) {
...
const AUDIO_EXTENSIONS = /* @__PURE__ */ new Set([".wav", ".mp3", ".aiff", ".flac", ".ogg", ".m4a"]);
...
async function registerHandlers() {
  ...
  ipcMain.handle("tags:update", async (_, filePath, tags) => {
  ...
  ipcMain.handle("folders:add", async (_, folderPath) => {
  ...
  ipcMain.handle("folders:remove", async (_, folderPath) => {
    ...
    for (const filePath of audioFiles) {
      try {
        ...
        try {
          ...
          format2 = metadata.format.container || "";
        } catch (e) {
...
export {
  ...
  BasicParser as B,
  uint8ArrayToHex as C,
  textDecode as D,
  EndOfStreamError as E,
  FourCcToken as F,
  Genres as G,
  tryParseApeHeader as H,
  INT16_BE as I,
  trimRightNull as J,
  ID3v2Header as K,
  ID3v1Parser as L,
  UINT24_LE as M,
  TextEncodingToken as N,
  decodeUintBE as O,
  TextHeader as P,
  SyncTextHeader as Q,
  findZero as R,
