import { l as f, F as s, B as z, c as w, d as I, n as S, f as D, a as c, b as u, U as l, S as b, m as g } from "./handlers-Krk-dW_N.js";
import "node:fs/promises";
import { I as C } from "./ID3v2Parser-Fx0o7yGw.js";
const o = {
  len: 12,
  get: (h, t) => ({
    // Group-ID
  ...
  async handleSoundPropertyChunks(t) {
    for (a(`Parsing sound-property-chunks, remainingSize=${t}`); t > 0; ) {
      ...
      switch (e.chunkID.trim()) {
        case "FS": {
          const n = await this.tokenizer.readToken(l);
        ...
        case "ABSS": {
          const n = await this.tokenizer.readToken(c), k = await this.tokenizer.readToken(u), m = await this.tokenizer.readToken(u), p = await this.tokenizer.readToken(l);
          a(`ABSS ${n}:${k}:${m}.${p}`);
          break;
        }
        case "LSCO": {
