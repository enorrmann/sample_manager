...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-DFJmVwHC.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-CjFoumNK.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-OtFVOT2n.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-CEgl37b2.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser--58rcBGh.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-BrtdYd0Q.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-B2GTNIQ6.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-D0uEVTPA.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-DqKMZVp-.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-BeDjBkil.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-CjtJ2U6S.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-C-IBbEbu.js")).WaveParser;
  }
};
      ...
      for (const filePath of audioFiles) {
        try {
          ...
          if (tags.length === 0) {
            ...
            const inferred = parts.filter((p) => isNaN(Number(p)) && p.length > 2);
            tags = inferred.map((t) => t.charAt(0).toUpperCase() + t.slice(1).toLowerCase());
          }
          samples.push({
            id: v4(),
