import { N as TextEncodingToken, c as initDebug, e as decodeString, b as UINT8, O as decodeUintBE, P as TextHeader, Q as SyncTextHeader, R as findZero, A as AttachedPictureType, m as makeUnexpectedFileContentError, U as UINT32_BE, G as Genres, V as UINT32SYNCSAFE, D as textDecode, y as UINT24_BE, k as getBit, K as ID3v2Header, W as ExtendedHeader, d as Uint8ArrayType } from "./handlers-B_3DJmUo.js";
        ...
        if (includeCovers) {
          ...
          switch (this.major) {
            ...
            case 4:
              ...
              break;
            default:
              throw makeUnexpectedMajorVersionError$2(this.major);
          }
...
function getFrameHeaderLength(majorVer) {
  switch (majorVer) {
    ...
    case 4:
      return 10;
    default:
      throw makeUnexpectedMajorVersionError$1(majorVer);
  }
}
