import { f as l, d as D, j as I, F as u, B as f, H as z, c as B, M as S, b as m, C as w, m as x } from "./handlers-T6Yq61Lr.js";
const P = [
  6e3,
  8e3,
  9600,
  ...
  len: 32,
  get: (e, t) => {
    const a = l.get(e, t + 24), s = {
      // should equal 'wvpk'
      BlockID: u.get(e, t),
      //  0x402 to 0x410 are valid for decode
      blockSize: l.get(e, t + 4),
      ...
      // 40-bit total samples for entire file (if block_index == 0 and a value of -1 indicates an unknown length)
      blockSamples: l.get(e, t + 20),
      // various flags for id and decoding
      flags: {
        bitsPerSample: (1 + d(a, 0, 2)) * 8,
        isMono: i(a, 2),
        isHybrid: i(a, 3),
        isJointStereo: i(a, 4),
        crossChannel: i(a, 5),
        hybridNoiseShaping: i(a, 6),
        floatingPoint: i(a, 7),
        samplingRate: P[d(a, 23, 4)],
        isDSD: i(a, 31)
      },
      // crc for actual decoded data
      crc: new D(4).get(e, t + 28)
    };
...
class v extends f {
  ...
  async parseWavPackBlocks() {
    do {
      ...
      if (a.BlockID !== "wvpk")
        throw new g("Invalid WavPack Block-ID");
      ...
      const s = a.blockSize - (c.len - 8);
      await (a.blockIndex === 0 ? this.parseMetadataSubBlock(a, s) : this.tokenizer.ignore(s)), a.blockSamples > 0 && (this.audioDataSize += a.blockSize);
  ...
  async parseMetadataSubBlock(t, a) {
    ...
    for (; s > k.len; ) {
      ...
      switch (await this.tokenizer.readBuffer(r), o(`Metadata Sub-Blocks functionId=0x${n.functionId.toString(16)}, id.largeBlock=${n.largeBlock},data-size=${r.length}`), n.functionId) {
        ...
        case 14: {
          o("ID_DSD_BLOCK");
          const b = 1 << m.get(r, 0), p = t.flags.samplingRate * b * 8;
          if (!t.flags.isDSD)
            throw new g("Only expect DSD block if DSD-flag is set");
      ...
      s -= k.len + (n.largeBlock ? S.len : m.len) + h * 2, o(`remainingLength=${s}`), n.isOddSize && this.tokenizer.ignore(1);
    }
    if (s !== 0)
      throw new g("metadata-sub-block should fit it remaining length");
  }
}
export {
