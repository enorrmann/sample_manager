import { b as g, j as C, f as d, S as l, m as F, p as i, J as _, c as p, y as b, a as T, k as u, h as I, F as N, B as E, E as z, d as H } from "./handlers-T6Yq61Lr.js";
import "node:fs/promises";
import { V as w, F as x, B as k, a as h, b as L, c as B } from "./FlacParser-DKBYtNIB.js";
...
const $ = {
  len: 80,
  get: (a, e) => ({
    speex: new l(8, "ascii").get(a, e + 0),
    version: _(new l(20, "ascii").get(a, e + 8)),
...
}, y = p("music-metadata:parser:ogg:theora");
class D {
  constructor(e, t, s) {
...
const G = {
  len: 27,
  get: (a, e) => ({
    capturePattern: new l(4, "latin1").get(a, e),
    version: g.get(a, e + 4),
    headerType: {
      continued: u(a, e + 5, 0),
      firstPage: u(a, e + 5, 1),
