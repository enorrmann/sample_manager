import { v as INT32_BE, w as INT24_BE, x as INT8, U as UINT32_BE, S as StringType, a as UINT16_BE, y as UINT24_BE, b as UINT8, m as makeUnexpectedFileContentError, F as FourCcToken, t as UINT64_BE, d as Uint8ArrayType, k as getBit, c as initDebug, I as INT16_BE, B as BasicParser, z as Token, C as uint8ArrayToHex, D as textDecode, G as Genres, T as TrackType } from "./handlers-DQLCOrNG.js";
      ...
      switch (child.header.name) {
        ...
        case "trun": {
          ...
          if (tfhd) {
            ...
            track == null ? void 0 : track.fragments.push({ header: tfhd, trackRun: trun });
          }
          break;
        }
        default: {
