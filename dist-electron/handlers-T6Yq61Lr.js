...
const Kr = {
  ...
  async load() {
    return (await import("./MpegParser-C4IhuvFP.js")).MpegParser;
  }
}, Jr = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-Dw81bnOn.js")).AsfParser;
  }
}, en = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-Buo1OsuO.js")).DsdiffParser;
  }
}, tn = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-DzuSKd8n.js")).AIFFParser;
  }
}, rn = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-CuqOVRXx.js")).DsfParser;
  }
}, nn = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-DKBYtNIB.js").then((i) => i.d)).FlacParser;
  }
}, an = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-Brnv2-mN.js")).MatroskaParser;
  }
}, sn = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-CuPyaApY.js")).MP4Parser;
  }
}, on = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-Baxmar5i.js")).MusepackParser;
  }
}, cn = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-BD6pVfXL.js")).OggParser;
  }
}, ln = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-DLpVhSd2.js")).WavPackParser;
  }
}, un = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-BJeSDr1t.js")).WaveParser;
  }
